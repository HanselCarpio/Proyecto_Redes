...
public class User {
    ...
    public void addUser(String nombre, String contrasena) throws SQLException {
        String query = "";
        ...
        if (sentence.executeUpdate(query) > 0) {
            ...
            File directorio = new File("C:\\Users\\bryan\\Documents\\NetBeansProjects\\Proyecto Redes (B63727_B40425)\\Server_TFTP\\Carpetas\\" + nombre);
            directorio.mkdir();
        } else {
